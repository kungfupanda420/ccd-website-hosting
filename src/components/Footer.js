            ...
            <div className="footer">
                <div className="footerContent smallHeading">
                   ...
                   <div className="footerSubContent">
                    ...
                    <ul className='footerLinks '>
                       <li><a href="https://www.linkedin.com/company/training-placement-cell-nit-calicut/?originalSubdomain=in" rel="noreferrer" target='_blank'>Linked In</a></li>
                ...
                <p className='tinyHeading copyRight'>Desgined & Built at NIT Calicut</p>
            </div>
        </>
    )
}
