  ...
  const validateForm = () => {
    ...
    if (currentStep === 4) {
      ...
      if (!formData.bonafide)
        newErrors.bonafide = "Bonafide Certificate is required";
      if (!formData.tenthMarksheet)
        newErrors.tenthMarksheet = "10th Marksheet is required";
      if (!formData.twelfthMarksheet)
        newErrors.twelfthMarksheet = "12th Marksheet is required";
    ...
    if (file) {
      ...
      img.onload = () => {
        ...
        if (width !== expectedWidth || height !== expectedHeight) {
          errors.photo =
            "Photo must be exactly 2x2 inches (192x192 pixels at 96 DPI).";
        }
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label htmlFor="cgpa10">
                10th CGPA <span className="required">*</span>
              </label>
              <input
                type="text"
                id="cgpa10"
            ...
            <div className="form-group">
              <label htmlFor="cgpa12">
                12th CGPA <span className="required">*</span>
              </label>
              <input
                type="text"
                id="cgpa12"
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label htmlFor="resume">
                Resume (PDF only) <span className="required">*</span>
              </label>
              <input
                type="file"
                id="resume"
            ...
            <div className="form-group">
              ...
              />
              {errors.statement && (
                <span className="error-message">{errors.statement}</span>
              )}
            </div>
            <div className="form-group">
              <label htmlFor="bonafide">
                Bonafide Certificate (PDF only){" "}
                <span className="required">*</span>
              </label>
              <input
                type="file"
              ...
              />
              {errors.bonafide && (
                <span className="error-message">{errors.bonafide}</span>
              )}
            </div>
            <div className="form-group">
              <label htmlFor="tenthMarksheet">
                10th Marksheet (PDF only) <span className="required">*</span>
              </label>
              <input
                type="file"
                id="tenthMarksheet"
              ...
              {errors.tenthMarksheet && (
                <span className="error-message">{errors.tenthMarksheet}</span>
              )}
            </div>
            <div className="form-group">
              <label htmlFor="twelfthMarksheet">
                12th Marksheet (PDF only) <span className="required">*</span>
              </label>
              <input
                type="file"
                id="twelfthMarksheet"
              ...
              {errors.twelfthMarksheet && (
                <span className="error-message">{errors.twelfthMarksheet}</span>
              )}
            </div>
            <div className="form-group">
              <label htmlFor="idCard">
                ID Card (PDF only) <span className="required">*</span>
              </label>
              <input
                type="file"
                id="idCard"
            ...
            <div className="form-group">
              <label htmlFor="photo">
                Photo (Passport Size: 2x2 inches, less than 50KB){" "}
                <span className="required">*</span>
              </label>
              <input
                type="file"
        ...
        return (
          <div className="form-section">
            ...
            <div className="form-group">
              <label>
                ID Card:{" "}
                {formData.idCard ? formData.idCard.name : "No file selected"}
              </label>
            </div>
            <div className="form-group">
              <label>
            ...
            <div className="form-group checkbox-group">
              ...
              <label htmlFor="agreeToTerms">
                ...
                complete. I understand that any false information may result in
