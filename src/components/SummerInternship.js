  ...
  const handlePhotoChange = (e) => {
    ...
    if (file) {
      ...
      img.onload = () => {
        ...
        if (width !== 2 * 96 || height !== 2 * 96) {
          errors.photo = "Image dimensions must be 2x2 inches.";
        }
        setErrors(errors);
      };
      ...
      case 5:
        return (
          <div className="form-section">
            <h2>Payment</h2>
            <div className='form-group'>
              <img src="/images/payment.jpg" alt="Payment Instructions" />
            </div>
            <div className="form-group">
              <label htmlFor='transaction-id'>Transaction ID <span className="required">*</span></label>
              <input type="text" id="transaction-id" name="transactionId" value={formData.transactionId} onChange={handleChange} className={errors.transactionId ? "error" : ""} />
              {errors.transactionId && <span className="error-message">{errors.transactionId}</span>}
            </div>
            <div className='form-group'>
              <label htmlFor='payment-screenshot'>Payment Screenshot <span className="required">*</span></label>
              <input type="file" id="payment-screenshot" name="payment" accept=".jpg,.jpeg,.png" onChange={handleChange} className={errors.payment ? "error" : ""} />
