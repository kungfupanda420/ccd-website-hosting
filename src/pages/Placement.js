        ...
        <ul>
          <li>
            <p className="tinyTexts">
              Students must be available at the designated time and venue for
              tests, group discussions, and interviews, and should dress
              formally.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Wearing clean and well-pressed professional attire is mandatory
              for attending pre-placement talks, tests, group discussions, and
              interviews.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Students are expected to maintain the highest levels of integrity
              and ethics when providing data to recruiters. Any incorrect
              information may result in disciplinary action.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Engaging in malpractice during any stage of the selection process
              will lead to disqualification from the placement/internship
              campaign.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Students should thoroughly read the job description and be
              well-informed about the firm before applying. Once applied,
              withdrawal is not allowed without prior permission.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Respect the hierarchy and communicate with the respective
              placement representative. Unresolved issues can be escalated to
              the department faculty representative and, if necessary, to the
              FA/HoD.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Students should have an impressive resume with accurate contact
              details, a LinkedIn profile, details of projects, and information
              on courses taken outside the curriculum.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              In virtual drives, students are responsible for ensuring a
              reliable internet connection, a backup laptop, a suitable
              background, functional camera and microphone, and should adhere to
              deadlines.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              Deadlines set by the CCD (Career and Course Development) must be
              strictly followed.
            </p>
          </li>
          <li>
            <p className="tinyTexts">
              CCD has the authority to issue warnings, reject profiles in
              genskill for a minimum of two weeks, debar students from
              internship/placement campaigns, or escalate matters to the Dean
              (Academic) for further action.
            </p>
          </li>
        </ul>
      </div>
...
// <div className="questionnContainer">
//   <div className="question smallHeading">question? {arrowSvg} </div>
//   <div className="answer tinyTexts">answer</div>
// </div>
      ...
      //   <p className="smallHeading">How to Register</p>
      //   <p className="tinyTexts">
      ...
      //     refer the following resources for familiarity and e-support. Resource:
      //     https://genskill.com/ https://app.genskill.com/documentation/videos/
      //   </p>
      ...
      //       <p className="smallHeading">Shortlisting of candidatesv</p>
      //       <p className="tinyTexts">
