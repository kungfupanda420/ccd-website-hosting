  ...
  useEffect(() => {
    ...
    return(
      ...
      <div className="pageContent" >
        <h1 className="pageHeading" data-aos="zoom-in">Placement/Internship</h1>
        <p className="tinyTexts" data-aos="zoom-in">
          The CCD gives due importance to the internship activities, which provides students an opportunity for career exploration and development & to learn new skills. CCD invites various leading firms and reputed research organisations for the internship drive. The Internship drive for the pre-final year B.Tech students usually commences in the month of August every year. The companies have to register in the Genskill portal and submit the Internship Notification Form (INF) for participating in the Internship drive. CCD offers the following four types of internships for the students during their programme. 
        </p>

        <p className='smallHeading' data-aos="zoom-in">Two months internship for the pre-final year b.tech</p>
        ...
        <p className='smallHeading' data-aos="zoom-in">Six months internship for the final year b.tech students</p>
